...
-- custom
hl.bind(mainMod .. " + ESCAPE", hl.dsp.exec_cmd("killall waybar && waybar")) -- reload waybar
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen({ action = "toggle" }))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("~/.config/hypr/scripts/desktop.sh")) -- show desktop
...
-- Toggle the "gamemode" tweaks (see scripts/gamemode.sh)
